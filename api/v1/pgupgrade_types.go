...
type PgUpgradeSpec struct {
	...
	// The label of the primary database.
	// e.g. If `Labels: app=postgres-master`, then `OldDBLabel=postgres-master`
	OldDBLabel string `json:"olddblabel,omitempty"`

	// Name of .sql file generated by pg_dump.
	PgDumpFileName string `json:"pgdumpfilename,omitempty"`
